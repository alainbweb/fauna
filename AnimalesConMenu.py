class Animal:
    especie = "Animal"  #Porque no queremos que se cambie, siempre será animal.

    def __init__(self, nombre, edad):
        self._nombre = nombre               #El guion bajo _ indica que no deben ser modificados directamente desde fuera de la clase (convención, no restricción).
        self._edad = edad
...
class ListaAnimales:
    ...
    def menu(self): #Estará en otra clase que se llame menu.py
        while True:
            print("\n---- Menu ----")
...
# Programa principal        #principal.py
